<div class="main-panel">
  <div class="content">
    <div class="page-inner">
      ...
      <div class="row">
        <div class="col-md-12">
          <form role="form" action="<?php echo site_url('CARole/tambah') ?>" method="post" enctype="multipart/form-data">
          <div class="card">
              ...
              <div class="row">
                <div class="col-md-6 col-lg-12">
                  <div class="form-group">
                    ...
                    <small style="color:red;"><?php echo form_error('role_name') ?></small>
                  </div>
                  <div class="form-group">
