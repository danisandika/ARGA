  ...
  <div class="card">
    <div class="card-header">
      <div class="d-flex align-items-center">
        ...
        <a href="<?php echo site_url('CAEmployee/tEmployee')?>" class="btn btn-primary btn-round ml-auto">
            ...
            <tr>
              ...
              <td>
                <div class="form-button-action">
                  <a href="<?php echo site_url('CAEmployee/edit/'.$item->id_user) ?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
                    <i class="fa fa-edit"></i>
                  </a>
                  <?php if($item->status==1){ ?>
                    <a  data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove" onclick="deleteConfirm('<?php echo base_url('CAEmployee/delete/'.$item->id_user) ?>')">
                      <i class="fa fa-times"></i>
                    </a>
                  <?php }else{ ?>
                    <a data-toggle="tooltip" title="" class="btn btn-link btn-success" data-original-title="Activate" onclick="aktifConfirm('<?php echo base_url('CAEmployee/active/'.$item->id_user) ?>')">
