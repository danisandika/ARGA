<div class="main-panel">
  <div class="content">
    <div class="page-inner">
      ...
      <div class="row">
        <div class="col-md-12">
          <form role="form" action="<?php echo site_url('CAEmployee/tambah') ?>" method="post" enctype="multipart/form-data">
          <div class="card">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="employee_phone" placeholder="Enter Phone Number">
                    <small style="color:red;"><?php echo form_error('employee_phone') ?></small>
                  </div>
                  <div class="form-group">
                    <label for="email2">Date of Birth</label>
                    <input type="date" class="form-control" name="employee_dob" max="<?php echo date('Y-m-d'); ?>">
                  </div>
                </div>
                <div class="col-md-6 col-lg-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" id="exampleFormControlSelect1" name="employee_role" required>
                      <?php foreach($role as $item){ ?>
                        <option value="<?php echo $item->id_role; ?>"><?php echo $item->nama_role; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-radio-label">
                      <input class="form-radio-input" type="radio" name="employee_gender" value="Male"  checked="">
                      <span class="form-radio-sign">Male</span>
                    </label>
                    <label class="form-radio-label ml-3">
                      <input class="form-radio-input" type="radio" name="employee_gender" value="Female">
