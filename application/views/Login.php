...
<!--===============================================================================================-->
	<link rel="icon" type="image/png" href="<?php echo base_url('Atlantis/assets/img/logoico.ico');?>"/>
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(<?php echo base_url('Login/images/HandShake.jpg')?>);">
					<span class="login100-form-title-1">
						Sign In
					</span>
				</div>

				<form class="login100-form validate-form" method="post" action="<?php echo site_url('CLogin/cekLogin') ?>">
					...
					<div class="flex-sb-m w-full p-b-30">
						<div>
							<a href="<?php echo site_url('CUserpage') ?>" class="txt1">
								Go to Userpage?
							</a>
						</div>
					</div>
...
<!--===============================================================================================-->
  ...
  <?php endif; ?>
	...
	<script>
	swal("Success!", "<?php echo $this->session->flashdata('successUser') ?>", {
		icon : "success",
		buttons: {
			confirm: {
				className : 'btn btn-success'
