  ...
  <div class="card">
    <div class="card-header">
      <div class="d-flex align-items-center">
        ...
        <a href="<?php echo site_url('CPromo/tPromo')?>" class="btn btn-primary btn-round ml-auto">
            ...
            <tr>
              ...
              <td>
                <div class="form-button-action">
                  <a href="<?php echo site_url('CPromo/edit/'.$item->id_promo) ?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
                  ...
                  <?php if($item->status==1){ ?>
                    <a  data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove" onclick="deleteConfirm('<?php echo base_url('CPromo/delete/'.$item->id_promo) ?>')">
                      <i class="fa fa-times"></i>
                    </a>
                  <?php }else{ ?>
                    <a data-toggle="tooltip" title="" class="btn btn-link btn-success" data-original-title="Activate" onclick="aktifConfirm('<?php echo base_url('CPromo/active/'.$item->id_promo) ?>')">
