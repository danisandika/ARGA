<?php
if($this->session->userdata('user_role') != 'superadministrator')
{
  $this->session->set_flashdata("failed", "You are not an Super Administrator");
...
<body>
	<div class="wrapper">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										...
										<a class="dropdown-item" href="<?php echo site_url('CProfil/editUserSuperadmin/'.$this->session->userdata('user_userID'))?>">Edit Profile</a>
										<a class="dropdown-item" href="<?php echo site_url('CProfil/editpassSuperadmin/'.$this->session->userdata('user_userID'))?>">Edit Password</a>
										<div class="dropdown-divider"></div>
		...
		<div class="sidebar sidebar-style-2">
				...
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item <?php echo $this->uri->segment(1)=='CDashboard'? 'active':''?>">
							<a  href="<?php echo site_url('CDashboard/index') ?>" class="collapsed" aria-expanded="false">
						...
						<li class="nav-section">
							...
							<h4 class="text-section">Sales Person</h4>
						</li>
						<li class="nav-item <?php echo $this->uri->segment(1)=='CActivity'? 'active':''?>">
							<a href="<?php echo site_url('CActivity')?>">
								<i class="fas fa-pen-square"></i>
								<p>Activity Plan</p>
							</a>
						</li>
            <li class="nav-item <?php echo $this->uri->segment(1)=='CRevenue'? 'active':''?>">
							<a  href="<?php echo site_url('CRevenue')?>">
								<i class="fas fa-money-bill-alt"></i>
								<p>Revenue</p>
							</a>
						</li>
            <li class="nav-item <?php echo $this->uri->segment(1)=='CVisit'? 'active':''?>">
							<a href="<?php echo site_url('CVisit')?>">
            ...
            <li class="nav-item <?php echo $this->uri->segment(1)=='CPromo'? 'active':''?>">
							<a href="<?php echo site_url('CPromo')?>">
								<i class="fas fa-tags"></i>
								<p>Promotion</p>

							</a>
						</li>
            <li class="nav-item <?php echo $this->uri->segment(1)=='CInfo'? 'active':''?>">
							<a href="<?php echo site_url('CInfo')?>">
            ...
            <li class="nav-item <?php echo $this->uri->segment(1)=='CEmployee'? 'active':''?>">
							<a href="<?php echo site_url('CEmployee')?>">
								<i class="fas fa-user-tie"></i>
								<p>Employee</p>
							</a>
						</li>
            <li class="nav-item <?php echo $this->uri->segment(1)=='CCustomer'? 'active':''?>">
							<a href="<?php echo site_url('CCustomer')?>">
								<i class="fas fa-user-friends"></i>
								<p>Customer</p>
							</a>
						</li>
						<li class="nav-item <?php echo $this->uri->segment(1)=='CRole'? 'active':''?>">
							<a href="<?php echo site_url('CRole')?>">
								<i class="fas fa-user-tie"></i>
								<p>Role</p>
							</a>
						</li>
