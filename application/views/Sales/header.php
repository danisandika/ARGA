<?php
if($this->session->userdata('user_role') != 'Sales')
{
  $this->session->set_flashdata("failed", "You are not an Sales");
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										...
										<a class="dropdown-item" href="<?php echo site_url('CProfil/editUserSales/'.$this->session->userdata('user_userID'))?>">Edit Profile</a>
										<a class="dropdown-item" href="<?php echo site_url('CProfil/editpasssales/'.$this->session->userdata('user_userID'))?>">Edit Password</a>
										<div class="dropdown-divider"></div>
          ...
          <!--MENU MENU NAV-->
					<ul class="nav nav-primary">
						...
						<li class="nav-item <?php echo $this->uri->segment(1)=='CDashboard'? 'active':''?>">
							<a  href="<?php echo site_url('CDashboard/index3')?>" class="collapsed" aria-expanded="false">
						...
						<li class="nav-item <?php echo $this->uri->segment(1)=='CSActivity'? 'active':''?>">
							<a  href="<?php echo site_url('CSActivity')?>">
								<i class="fas fa-pen-square"></i>
								<p>Activity Plan</p>
							</a>
						</li>
            <li class="nav-item <?php echo $this->uri->segment(1)=='CSRevenue'? 'active':''?>">
							<a  href="<?php echo site_url('CSRevenue')?>">
								<i class="fas fa-money-bill-alt"></i>
								<p>Revenue</p>
							</a>
						</li>
            <li class="nav-item <?php echo $this->uri->segment(1)=='CSVisit'? 'active':''?>">
							<a  href="<?php echo site_url('CSVisit')?>">
            ...
            <li class="nav-item">
							<a href="<?php echo site_url('CSPromo')?>">
            ...
            <li class="nav-item">
							<a href="<?php echo site_url('CSInfo')?>">
