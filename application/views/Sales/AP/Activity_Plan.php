  ...
  <div class="card">
    <div class="card-header">
      <div class="d-flex align-items-center">
        ...
        <a href="<?php echo site_url('CSActivity/tActivity')?>" class="btn btn-primary btn-round ml-auto">
            ...
            <tr>
              ...
              <td>
                <div class="form-button-action">
                  <a href="<?php echo site_url('CSVisit/view_Visit/'.$item->ap_id) ?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="View Visit">
                    <i class="fa fa-edit"></i>
                  </a>
                  <a href="-" data-toggle="modal" title="" class="btn btn-link btn-info view_activity" relid="<?php echo $item->ap_id;  ?>" >
