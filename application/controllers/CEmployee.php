...
class CEmployee extends CI_Controller {
	...
	public function index()
	{
     ...
     $this->load->view('SuperAdministrator/Employee/vEmployee',$data);
  ...
  public function tEmployee()
  {
    ...
    $data['title']= "Employee";
    $this->load->view('SuperAdministrator/header',$data);
    $this->load->view('SuperAdministrator/Employee/tEmployee',$data);
    $this->load->view('SuperAdministrator/footer');
  }
	...
	public function tambah()
  {
      ...
      $validation = $this->form_validation;
	    ...
	    if ($this->form_validation->run() == TRUE){
	       $result = $em->save();
            ...
            redirect(site_url('CEmployee/index'));
          }else{
    ...
    public function edit($id=null)
	  {
	    if(!isset($id))redirect('CEmployee/index');
	    ...
	    $data['title']= "Employee";
	    $this->load->view('SuperAdministrator/header',$data);
	    $this->load->view('SuperAdministrator/Employee/eEmployee',$data);
	    $this->load->view('SuperAdministrator/footer');
	  }
