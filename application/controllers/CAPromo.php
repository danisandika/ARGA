...
class CAPromo extends CI_Controller {
   ...
   public function __construct()
   {
	...
	public function index()
	{
     ...
     $this->load->view('Administrator/Promo/vPromo',$data);
  ...
  public function tPromo()
  {
    $data['title']= "Promotion";
    $this->load->view('Administrator/header',$data);
    $this->load->view('Administrator/Promo/tPromo',$data);
    $this->load->view('Administrator/footer');
  }
  ...
  public function tambah()
  {
      ...
      $validation = $this->form_validation;
	    ...
	    if ($this->form_validation->run() == TRUE){
	       $result = $promo->save();
            ...
            redirect(site_url('CAPromo/index'));
          }else{
    ...
    public function edit($id=null)
	  {
	    if(!isset($id))redirect('CAPromo/index');

	    $promo = $this->MPromo;
	    $data["promo"]=$promo->getByID($id);
	    $data['title']= "Promotion";
	    $this->load->view('Administrator/header',$data);
	    $this->load->view('Administrator/Promo/ePromo',$data);
	    $this->load->view('Administrator/footer');
	  }
