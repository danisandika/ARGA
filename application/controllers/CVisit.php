...
class CVisit extends CI_Controller {
   ...
   public function index()
 	{
      ...
      $this->load->view('SuperAdministrator/Visit/list_sales',$data);
  ...
  public function list_activity($id_user)
  {
     ...
     $data['title']= "Visit";
     $this->load->view('SuperAdministrator/header',$data);
     $this->load->view('SuperAdministrator/Visit/list_activity',$data);
     $this->load->view('SuperAdministrator/footer');
  }
  ...
  public function list_visit($id)
  {
     ...
     $data['title']= "Visit";
     $this->load->view('SuperAdministrator/header',$data);
     $this->load->view('SuperAdministrator/Visit/list_visit',$data);
     $this->load->view('SuperAdministrator/footer');
  }
