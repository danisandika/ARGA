...
class CPromo extends CI_Controller {
   ...
   public function __construct()
   {
	...
	public function index()
	{
     ...
     $this->load->view('SuperAdministrator/Promo/vPromo',$data);
  ...
  public function tPromo()
  {
    $data['title']= "Promotion";
    $this->load->view('SuperAdministrator/header',$data);
    $this->load->view('SuperAdministrator/Promo/tPromo',$data);
    $this->load->view('SuperAdministrator/footer');
  }
  ...
  public function tambah()
  {
      ...
      $validation = $this->form_validation;
	    ...
	    if ($this->form_validation->run() == TRUE){
	       $result = $promo->save();
            ...
            redirect(site_url('CPromo/index'));
          }else{
    ...
    public function edit($id=null)
	  {
	    if(!isset($id))redirect('CPromo/index');

	    $promo = $this->MPromo;
	    $data["promo"]=$promo->getByID($id);
	    $data['title']= "Promotion";
	    $this->load->view('SuperAdministrator/header',$data);
	    $this->load->view('SuperAdministrator/Promo/ePromo',$data);
	    $this->load->view('SuperAdministrator/footer');
	  }
