...
class CSInfo extends CI_Controller {
   ...
   public function __construct()
   {
	...
	public function index()
	{
     ...
     $this->load->view('Sales/Info/vInfo',$data);
  ...
  public function tInfo()
  {
    $data['title']= "Information";
    $this->load->view('Sales/header',$data);
    $this->load->view('Sales/Info/tInfo',$data);
    $this->load->view('Sales/footer');
  }
  ...
  public function tambah()
  {
      ...
      $validation = $this->form_validation;
	    ...
	    if ($this->form_validation->run() == TRUE){
	       $result = $info->save();
            ...
            redirect(site_url('CSInfo/index'));
          }else{
    ...
    public function edit($id=null)
	  {
	    if(!isset($id))redirect('CSInfo/index');

	    $info = $this->MInfo;
	    $data["info"]=$info->getByID($id);
	    $data['title']= "Information";
	    $this->load->view('Sales/header',$data);
	    $this->load->view('Sales/Info/eInfo',$data);
	    $this->load->view('Sales/footer');
	  }
